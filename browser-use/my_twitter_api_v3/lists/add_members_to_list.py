...
async def add_members_to_list(name = "my_list", handle=None, membersToAdd=[]):
    ...
    agent = Agent(
        task=(
            "Select the list with the name " + name + ". Select 'Edit List'. Select 'Manage members'. Go to the 'Suggested' tab. Search the following people: " + 
            membersToAdd
        ),
...
if __name__ == "__main__":
    asyncio.run(add_members_to_list())